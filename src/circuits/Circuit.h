...
{
public:
    Circuit(OrientedGraph* const i_graph, const std::vector<std::string> &i_logExpressions = {});
    void computeHash();
    ...
    std::vector<GraphVertexBase*> getIndexOfWireName(const std::string &i_wireName);
