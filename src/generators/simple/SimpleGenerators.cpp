        ...
        bool act)
{
    ...
    std::string cond = std::string(compare0 ? "t" : "f") + (compare1 ? "t" :
        ...
        std::shared_ptr<GraphVertexBase> not_nb = graph.addGate(Gates::GateNot, "nb" + C);
        std::shared_ptr<GraphVertexBase> nb = graph.addGate(Gates::GateAnd, "nb" + C);
        graph.addEdge(input_y, not_nb);
        std::shared_ptr<GraphVertexBase> not_na = graph.addGate(Gates::GateNot, "na" + C);
        std::shared_ptr<GraphVertexBase> na = graph.addGate(Gates::GateAnd, "na" + C);
        ...
        if (compare0){
            ...
            std::shared_ptr<GraphVertexBase> pn_ = graph.addGate(Gates::GateOr, "p0_" + NextC);
...
OrientedGraph SimpleGenerators::generatorMultiplier(
        int i_bits,
        bool act)
{
    OrientedGraph graph;
