...
public:
    ...
    /// of a Cascade machine. Generator creates a Cascade machine with random transitions
    /// and outputs based on the given parameters. The result is in a form of OrientedGraph.
