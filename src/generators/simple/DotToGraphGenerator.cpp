...
#include "DotToGraphGenerator.hpp"

namespace CG_Gen {

DotToGraphGenerator::DotToGraphGenerator() : SimpleGenerator() {
}
DotToGraphGenerator::DotToGraphGenerator(uint_fast32_t i_seed) :
    SimpleGenerator(i_seed) {
}
DotToGraphGenerator::DotToGraphGenerator(const GenerationParameters &i_param) :
...
GraphPtr DotToGraphGenerator::generatorDotToGraphMealy(std::string i_DotPath) {
...
GraphPtr DotToGraphGenerator::generatorDotToGraphMoore(std::string i_DotPath) {
  std::string content = std::filesystem::is_directory(i_DotPath)
                            ? readDotFile(i_DotPath)
                            : readDotFile(i_DotPath);
...
GraphPtr
DotToGraphGenerator::generatorDotToGraph(const GenerationParameters &i_param) {
...
GraphPtr DotToGraphGenerator::generatorDotToGraph() {
