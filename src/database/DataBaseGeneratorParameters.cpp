...
DataBaseGeneratorParameters::DataBaseGeneratorParameters(
    ...
    int i_eachIteration, GenerationTypes i_gt, GenerationParameters i_gp)
...
int DataBaseGeneratorParameters::getMinInputs() const { return d_minInputs; }

int DataBaseGeneratorParameters::getMaxInputs() const { return d_maxInputs; }

int DataBaseGeneratorParameters::getMinOutputs() const { return d_minOutputs; }

int DataBaseGeneratorParameters::getMaxOutputs() const { return d_maxOutputs; }
...
std::string DataBaseGeneratorParameters::getGenerationTypeString() const {
  ...
  if (d_generationTypes == GenerationTypes::RandLevel) return "RandLevel";
  if (d_generationTypes == GenerationTypes::RandLevelExperimental)
    return "RandLevelExperimental";
  if (d_generationTypes == GenerationTypes::NumOperation) return "NumOperation";
  if (d_generationTypes == GenerationTypes::Genetic) return "Genetic";
  if (d_generationTypes == GenerationTypes::Summator) return "Summator";
  if (d_generationTypes == GenerationTypes::Comparison) return "Comparison";
  ...
  if (d_generationTypes == GenerationTypes::Decoder) return "Decoder";
  if (d_generationTypes == GenerationTypes::ALU) return "ALU";
