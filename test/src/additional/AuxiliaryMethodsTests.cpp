...
{
  std::string answer = "";
  std::string path = "../../test/test_data/AuxiliaryMethods/test_empty_file.txt";
>>>>>>> 442514d5a (commit before pull)
...
{
  std::string answer = "one line";
  std::string path = "../../test/test_data/AuxiliaryMethods/one_line_file.txt";
>>>>>>> 442514d5a (commit before pull)
...
{
  std::string answer = "one line\ntwo line";
  std::string path = "../../test/test_data/AuxiliaryMethods/test_two_lines.txt";
>>>>>>> 442514d5a (commit before pull)
...
{
  std::string answer = "one\ttab";
  std::string path = "../../test/test_data/AuxiliaryMethods/test_one_line_with_tab.txt";
>>>>>>> 442514d5a (commit before pull)
...
{
  std::string answer = "this\tis 2 lines\nthis is\tsecond line";
  std::string path = "../../test/test_data/AuxiliaryMethods/test_two_line_with_tab.txt";
>>>>>>> 442514d5a (commit before pull)
...
{
  std::string answer = "";
  std::string path = "../../test/test_data/AuxiliaryMethods/bla_bla_bla.txt";
>>>>>>> 442514d5a (commit before pull)
