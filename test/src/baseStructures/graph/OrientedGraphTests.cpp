...
//   EXPECT_EQ(graphPtr->getVerticeByIndex(1)->getType(),
...
//   EXPECT_EQ(
//       graphPtr->getVerticesByName("Anything")[0]->getType(),
//       VertexTypes::input
//   );
//   EXPECT_EQ(
...
//   // What should return at first VertexTypes::constant or
//   VertexTypes::output?
...
//   EXPECT_EQ(graphPtr->getEdgesGatesCount()[Gates::GateAnd][Gates::GateNand],
//   1);
//   EXPECT_EQ(graphPtr->getEdgesGatesCount()[Gates::GateAnd][Gates::GateOr],
//   0);
//   EXPECT_EQ(graphPtr->getEdgesGatesCount()[Gates::GateAnd][Gates::GateAnd],
//   0);
//   EXPECT_EQ(graphPtr->getEdgesGatesCount()[Gates::GateAnd][Gates::GateNor],
//   0);
//   EXPECT_EQ(graphPtr->getEdgesGatesCount()[Gates::GateAnd][Gates::GateXor],
//   0);
//   EXPECT_EQ(graphPtr->getEdgesGatesCount()[Gates::GateAnd][Gates::GateXnor],
//   0);
//   EXPECT_EQ(graphPtr->getEdgesGatesCount()[Gates::GateAnd][Gates::GateNot],
//   0);
//   EXPECT_EQ(graphPtr->getEdgesGatesCount()[Gates::GateAnd][Gates::GateBuf],
//   0);
...
//   EXPECT_EQ(graphPtr->getEdgesGatesCount()[Gates::GateNand][Gates::GateAnd],
//   1);
//   EXPECT_EQ(graphPtr->getEdgesGatesCount()[Gates::GateOr][Gates::GateAnd],
//   1);
//   EXPECT_EQ(graphPtr->getEdgesGatesCount()[Gates::GateAnd][Gates::GateNand],
//   1);
// }
